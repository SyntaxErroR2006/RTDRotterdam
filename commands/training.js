...
module.exports.run = async (client, message, args) => {
    ...
    if (args[1] == "1") {
        ...
        var DienstSpecialeInterventiesEmbed = new discord.MessageEmbed()
            .setTitle("Landmacht training")
            .setColor("#02661d")
            .setFooter("RTD | Rotterdam", "https://cdn.discordapp.com/attachments/758699445356462110/769845913203769364/unknown.png")
            .addFields(
                { name: "Dienst", value: "Landmacht" },
                { name: "Type-Training", value: `${options.TypeTraining}` },
                { name: "Host", value: `${message.author}` },
                { name: "Co-host", value: `${options.Hulp}` },
                { name: "Datum", value: `${options.Datum}` },
            ...
            .setThumbnail("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/Kl-koninklijke-landmacht-4.svg/1200px-Kl-koninklijke-landmacht-4.svg.png")
